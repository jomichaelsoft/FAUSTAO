...
async function Handle(interaction) {
    ...
    const channel = interaction.options.getChannel(PokeStart_1.CommandOption.channel, true, [discord_js_1.ChannelType.GuildText]);
    if (host.bot) {
        interaction.reply({
            content: "**Error:** YOU ARE MISTAKEN. A BOT CANNOT BE A HOST",
            flags: discord_js_1.MessageFlags.Ephemeral,
        });
        return;
    }
